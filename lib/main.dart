          ...
          return ListView(
            children: <Widget>[
              ...
              ListTile(
                ...
                subtitle:
                    Text("Será entregado a la puerta de tu casa con Uber Eats"),
              ),
              ListTile(
                leading: ClipRRect(
                  child: Image.network(
                      'https://lh3.googleusercontent.com/XblDxQ9NEOogr-8fogjTjqnSrW3ufFq926-tBZ8Q-s9VqbIAtndut-X0_XxOC9WRTOoM'),
                  borderRadius: BorderRadius.circular(30),
                ),
                title: Text("Hugo"),
                  ...
                  ButtonBarTheme(
                    data: ButtonBarThemeData(
                        alignment: MainAxisAlignment
                            .center), // make buttons use the appropriate styles for cards
                    child: ButtonBar(
                      children: <Widget>[
                        TextButton.icon(
